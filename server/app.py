...
from API import UsersResources, AddMSGResources, GetMessagesResources, StatusResources, AboutResources
...
if __name__ == "__main__":
    ...
    try:
        ...
        api.add_resource(StatusResources.StatusResources, '/api/change_status')
        api.add_resource(AboutResources.AboutResources, '/api/change_about')
    except Exception as Error:
